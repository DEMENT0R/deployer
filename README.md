...
- **Recent deployments** — последние 20 деплоев: время, действие, ветка, кто запустил, длительность, статус
  и код выхода. Логи в таблицу не тянутся — они остаются на карточке текущего деплоя.
...
(разбор вывода git, detached HEAD, упавший git), история деплоев, health-пинг и `PathValidator`.
